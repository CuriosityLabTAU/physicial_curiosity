...
### run Behavior
managerProxy = ALProxy("ALBehaviorManager","192.168.0.100", 9559)
managerProxy.post.runBehavior("movements/no_no")
names = managerProxy.getInstalledBehaviors()
print "Behaviors on the robot:"
print names

audioProxy = ALProxy("ALAudioPlayer", "192.168.0.100", 9559)
...
AnimatedSpeechProxy = ALProxy("ALAnimatedSpeech","192.168.0.100", 9559)
